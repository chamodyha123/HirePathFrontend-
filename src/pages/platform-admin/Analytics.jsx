...
function Analytics() {
    ...
    if (error) return (
        <div style={{ color: '#ef4444', textAlign: 'center', padding: '40px', background: '#fff', borderRadius: '12px' }}>
            ⚠️ {error}
        </div>
    );
    ...
    return (
        <div className="profile-all-in-one">
            ...
            {/* --- SPLIT LAYOUT FOR ROLE DISTRIBUTION & SKILLS --- */}
            <div className="form-grid-2" style={{ gap: '24px' }}>
                ...
                <div className="card" style={{ padding: '24px' }}>
                    <h4 style={{ margin: '0 0 16px 0', color: 'var(--dark-text)', fontWeight: '700' }}>⚡ Top In-Demand Skills (Live Data)</h4>
